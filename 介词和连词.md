...
- **For**：表示为了某个目的。
  例子：I bought a gift **for** my friend's birthday.（我买了一份礼物**为了**我朋友的生日。）
...
- **Of**：表示某物的归属关系。
  例子：The book **of** my sister is on the shelf.（我姐姐的书在书架上。）
...
#### between
`between`通常用于两个明确的、单独的事物之间的关系。例如，您可以在描述两个人或物体之间的关系时使用它。

例句：The agreement was made between the two companies.

#### among
`among`用于描述三个或更多的人或事物之间的关系。通常，这些对象不会被视为单独的个体，而是作为一个群体。

例句：He is popular among his classmates.

#### around
`around`可用于描述环绕或围绕某个点或区域的物体的位置。

例句：We walked around the park.

#### against
`against`用于表示抵抗、反对或接触的关系。它也可以表示比较或对比。

例句：She leaned against the wall.

#### within
`within`通常用于表示在某个界限或范围内。

例句：The keys are within the drawer.

#### without
`without`用于表示缺乏或不存在的状态。

例句：I cannot imagine life without music.

#### beyond
`beyond`用于表示在某物的另一边，或超越了某个界限或范围。

例句：The forest extended beyond the horizon.

#### inside
`inside`用于表示在某个空间或物体内部。

例句：The cat is inside the box.
...
- 例句：The man with the red hat is my uncle. （"with the red hat"是介词短语，用作定语，修改名词"the man"。）

#### **作为状语**

介词短语可以用作状语，提供关于动词的更多信息，如时间、地点、方式等。

- 例句：She arrived after dinner. （"after dinner"是介词短语，用作状语，提供关于"She arrived"的时间信息。）

#### **作为主语或宾语**

尽管不太常见，但在某些情况下，介词短语可以充当句子的主语或宾语。

- 例句（主语）：Under the bed is a great place to hide. （"Under the bed"是介词短语，用作主语。）
- 例句（宾语）：She can't live without listening to music. （"listening to music"是介词短语，用作"live without"的宾语。）
...
- 例句：This is the man that I was talking about.

#### **被动语态**

在被动语态的句子中，如果动词短语包含介词，那么这个介词通常会出现在句尾。

- 例句：The book was looked for by all the students.
...
- 用于连接相同类型的词或短语：
  例子：I like apples and oranges.

- 用于连接相同类型的从句：
  例子：She is studying math and he is studying science.
...
- 用于连接相反或对比的信息：
  例子：I want to go out, but it's raining.

- 用于表示转折关系：
  例子：She is very talented, but she lacks confidence.
...
- 用于连接两个或多个可选项：
  例子：Would you like tea or coffee?

- 用于表示两种可能性之一：
  例子：You can stay at home or go out with friends.
...
- 用于连接连续否定的选项：
  例子：He neither eats meat nor dairy products.
...
- 用于表示转折或补充信息：
  例子：She is young, yet she has achieved so much.
...
- 用于表示因果关系：
  例子：It was raining, so we stayed indoors.
...
- 用于表示解释或提供原因：
  例子：He didn't come to the party, for he was feeling sick.
...
- 例句：She arrived **before** the meeting started.
- 例句：He called me **while** I was cooking dinner.

#### **原因从属连词**

- because, since
  - 例句：He didn't come to the party **because** he was sick.
  - 例句：She stayed at home **since** it was raining.

#### 条件从属连词

- if, unless
  - 例句：I will go shopping **if** I have time.
  - 例句：You won't pass the test **unless** you study hard.

#### 比较从属连词

- as, like, whereas
  - 例句：She sings **like** an angel.
  - 例句：He is tall, **whereas** his brother is short.

#### 目的从属连词

- so that, in order that
  - 例句：I bought a gift **so that** I could give it to her.
  - 例句：He studied hard **in order that** he could pass the exam.

#### 让步从属连词

- although, though, even though
  - 例句：**Although** it was raining, they decided to go out.
  - 例句：He went for a walk **even though** he was tired.

#### **方式从属连词**

- as, as if, as though
  - 例句：He talks **as if** he knows everything.
  - 例句：She danced **as though** nobody was watching.

#### **地点从属连词**

- where, wherever
  - 例句：This is the place **where** I grew up.
  - 例句：You can go **wherever** you want.

#### **选择从属连词**

- whether, if
  - 例句：I don't know **whether** he will come or not.
  - 例句：Please let me know **if** you can come to the party.
